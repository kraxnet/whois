...
#
#   /spec/fixtures/responses/whois.sk-nic.sk/sk/status_expired.expected
#
...
describe Whois::Record::Parser::WhoisSkNicSk, "status_expired.expected" do

  subject do
    file = fixture("responses", "whois.sk-nic.sk/sk/status_expired.txt")
